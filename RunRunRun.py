...
GROUND_HEIGHT = SCREEN_HEIGHT - 70          # distance from ground
...
class Cactus:
    ...
    def __init__(self, speed=10):
        ...
        self.cactus_images = load_sprites("image/cactus/", "cactus_", 6, 160, 160)
        self.var = random.randrange(0,6)
        self.cactus_image_0, self.rect_0 = self.cactus_images[self.var], self.cactus_images[self.var].get_rect()
        self.cactus_image_1, self.rect_1 = self.cactus_images[self.var], self.cactus_images[self.var].get_rect()

        self.rect_0.bottom = GROUND_HEIGHT - 11
        self.rect_0.left = SCREEN_WIDTH
        self.rect_1.bottom = GROUND_HEIGHT - 11
        self.rect_1.left = self.rect_0.right + random.randrange(int(SCREEN_WIDTH/4),int(SCREEN_WIDTH))
    ...
    def update_speed(self, speed):
        self.speed = speed
        self.range_0 += 1  # Random distance
        self.range_1 += 1
    ...
    def update(self):
        ...
        if self.rect_0.right < 0:
            ...
            temp_index = random.randrange(0, 6)
...
# class for creating and moving character
...
# class for counting and drawing score
class Score:
    ...
    def draw(self):
        ...
        draw_text(str(self.high_score), "font/monofonto.ttf", 28, (255, 255, 255), SCREEN_WIDTH - 60, 20, "topright")
        draw_text(str(self.score), "font/monofonto.ttf", 28, (255, 255, 255), SCREEN_WIDTH - 60, 65, "topright")
...
class GameOver:
    ...
    def draw(self):
        draw_text("GAME OVER", "font/northcliff_stencil.otf", 80, (255, 255, 255),
